...
namespace GamePlay.Client.Model
{
	...
	public class ClientRoundStatus : ISubject<ClientRoundStatus>
	{
		...
		public IList<Tile> ForbiddenTiles
		{
			get;
			private set;
		}
		...
		public IDictionary<Tile, IList<Tile>> PossibleWaitingTiles
		{
			get;
			private set;
		}

		public IList<Tile> WaitingTiles
		{
			get;
			private set;
		}

		public ClientLocalSettings LocalSettings
		{
			get;
			private set;
		}
