...
namespace GamePlay.Server.Controller.GameState
{
	public class RoundDrawState : ServerState
	{
		...
		{
			Assert.IsTrue(
				readyIndices.Count + notReadyIndices.Count == 3 && readyIndices.Count != 0 && readyIndices.Count != 0,
		...
		{
			Assert.IsTrue(
				readyIndices.Count + notReadyIndices.Count == 4 && readyIndices.Count != 0 && readyIndices.Count != 0,
				$"ready: {readyIndices.Count}, not ready: {notReadyIndices.Count}");
